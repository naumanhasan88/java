...
public class PalindromNum {
    public static void main(String[] args) {
        ...
        /* its pseudocode is like this 
         * 1. First we will get last digit using % operator.
         * 2. Then save it in a variable.
         * 3. then get the first 3 digits using / operator.
         * 4. and then save this with variable which is multiplied by 10, and repeat it.
         */
